...
*/
// admin routes
Route::group(['prefix' => 'admin/affiliate', 'namespace' => 'Modules\Affiliate\Http\Controllers', 'middleware' => ['auth', 'locale', 'permission', 'affiliate']], function () {
...
// site route
Route::group(['middleware' => ['site.auth', 'locale']], function () {
    Route::match(['get', 'post'],'/affiliate', [AffiliateRegistrationController::class, 'registration'])->name('site.affiliate.registration');
});

// customer route
Route::group(['prefix' => 'user/affiliate', 'namespace' => 'Modules\Affiliate\Http\Controllers\User', 'middleware' => ['auth', 'locale', 'affiliate']], function () {
