                                    ...
                                    <div class="col-sm-9">
                                        <div class="schedule-customer">
                                            <select id="schedule_id" class="form-control select2 sl_common_bx"
                                                ...
                                                @foreach (config('databasebackup.schedule_type_value') as $item)
                                                    <option value="{{ $item }}"
                                                        {{ config('databasebackup.schedule_type') == $item ? 'selected' : '' }}>
                                                        {{ ucwords($item) }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="schedule-customer">
                                            <select id="storage" class="form-control select2 sl_common_bx" name="storage"
                                                ...
                                                @foreach ($disks as $disk)
                                                    <option value="{{ $disk }}"
                                                        {{ config('databasebackup.storage') == $disk ? 'selected' : '' }}>
                                                        {{ ucwords($disk) }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="switch switch-bg d-inline m-r-10 edit-is_default">
                                            <input class="is_database_automated_backup" type="checkbox"
                                                ...
                                                {{ config('databasebackup.is_database_automated_backup') == true ? 'checked' : '' }}>
