...
class EsewaProcessor implements PaymentProcessorInterface, RequiresCallbackInterface, RequiresCancelInterface
{
    ...
    public function __construct()
    {
        ...
        $this->esewa = Esewa::firstWhere('alias', config('esewa.alias'))->data;
    }
    ...
    {
        $this->success_url =route('gateway.callback', ['gateway' => config('esewa.alias')]);
        $this->cancel_url = route('gateway.cancel', ['gateway' => config('esewa.alias')]);
    }
