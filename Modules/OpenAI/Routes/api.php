...
Route::group(['prefix' => '/V1/user/openai', 'middleware' => ['auth:api', 'locale', 'permission-api']], function() {
    ...
    Route::get('image/conversation/list', [ImageController::class, 'converstaionList']);
    Route::delete('image/delete', [ImageController::class, 'delete']);
    Route::get('image/view/{id}', [ImageController::class, 'view']);
    Route::get('image/conversation-view/{id}', [ImageController::class, 'converstaionView']);
    ...
    Route::get('preferences/providers', [OpenAIPreferenceController::class, 'aiProviders']);
    Route::get('preferences/all-data-list', [OpenAIPreferenceController::class, 'allAiData']);
