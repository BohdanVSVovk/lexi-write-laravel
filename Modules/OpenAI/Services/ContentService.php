...
use Modules\OpenAI\Traits\MetaTrait;
 ...
 class ContentService
 {
     ...
     * @return [type]
     */
    public function allAiData($imageService)
    {
        $data['contents'] = $this->getAll()->get();
        $data['image'] = $imageService->getAll()->get();
   
        foreach ($data['contents'] as &$subArray) { // This will be modified later
        ...
        return $data['contents']->merge($data['image'])->sortBy('created_at');
    }
