...
Route::group(['prefix' => 'gateway/paypal-recurring', 'as' => 'paypalrecurring.', 'namespace' => 'Modules\PaypalRecurring\Http\Controllers', 'middleware' => ['auth', 'permission', 'locale']], function () {
