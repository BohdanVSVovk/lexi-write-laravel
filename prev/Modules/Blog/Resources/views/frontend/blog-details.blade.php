        ...
        <div class="mx-4 lg:mx-4 2xl:mx-32 6xl:mx-64 9xl:mx-[375px]">
            ...
            <main>
                ...
                <div class="md:flex justify-between w-full mt-5">
                    <div class="md:w-4/6 lg:w-[69%] 3xl:w-full md:mr-8">
                        {{-- post cards --}}
                        <div>
                            <div class="left-side w-full h-[411px]">
                                <img src="{{ $blog->fileUrl() }}" class="rounded w-full object-cover lg:h-[411px] h-full" />
                            </div>
                        ...
                        @if (isset($blog->user) && !empty($blog->user))
                            <div class="lg:w-[833px] w-full lg:min-h-[152px] border rounded border-gray-2 box-border">
                                <div class="grid lg:grid-cols-4 grid-cols-2">
                                    <img class="h-24 w-24 my-7 object-cover rounded-full ml-7" src="{{ optional($blog->user)->fileUrl() }}"
                                        alt="{{ __('Image') }}">
                                    <div class="mt-8 lg:-ml-12">
                                        <p class="font-Figtree text-13 font-medium text-color-89 dark:text-color-DF">{{ __('Author') }}</p>
                                        <p class="font-Figtree font-medium text-18 mt-[2px] text-color-2C dark:text-white lg:w-[152px] break-words pr-5 lg:pr-0">
                                        ...
                                        <div class="flex my-3.5 cursor-pointer text-color-89 dark:text-color-DF">
                                            @if (optional($blog->user)->facebook)
                                                <a href="{{ optional($blog->user)->facebook }}">
                                                    <svg class="hover:text-color-2C dark:text-white transition ease-in-out delay-130 mr-3"
                                            ...
                                            @if (optional($blog->user)->twitter)
                                                <a href="{{ optional($blog->user)->twitter }}">
                                                    <svg class="t-0.5 hover:text-color-2C dark:text-white transition ease-in-out delay-130 mr-3"
                                            ...
                                            @if (optional($blog->user)->instagram)
                                                <a href="{{ optional($blog->user)->instagram }}">
                                                    <svg class="mt-0.5 hover:text-color-2C dark:text-white transition ease-in-out delay-130"
                                    ...
                                    <div class="border-l my-6 lg:block hidden border-line w-0 min-h-[100px] -ml-20"></div>
                                    <p class="lg:block hidden break-all my-10 italic text-left font-Figtree text-15 font-medium text-color-89 dark:text-color-DF mr-[30px] lg:-ml-[250px]">
                        ...
                        <div class="flex justify-end mt-8">
                            <div class="flex">
                                ...
                                @endif
                                <div class="flex text-color-89 dark:text-color-DF mr-1">
                                    @if ($social['facebook'])
                                    <a href="https://www.facebook.com/sharer.php?u={{ urlencode(url()->current()) }}"
                                        target="_blank">
                                        <svg class="transition ease-in-out delay-130 hover:text-color-2C dark:text-white hover:border-color-2C border border-color-DF rounded-full cursor-pointer mr-[7px]"
                                    ...
                                    <a href="https://api.whatsapp.com/send?text={{ urlencode(url()->current()) }}"
                                        target="_blank">
                                        <svg class="hover:text-color-2C dark:text-white transition ease-in-out delay-130 hover:border-color-2C border border-color-DF rounded-full cursor-pointer mr-[7px]"
                                            xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                            viewBox="0 0 25 25" fill="none">
                        ...
                        <div class="flex justify-between my-[30px] gap-3">
                            @if ($previousUrl)
                                <div class="flex flex-col items-start justify-center lg:justify-start">
                                    <a href="{{ route('blog.details', $previousUrl->slug) }}" class="flex relative arrow-hover pl-4 md:text-16 text-14 font-Figtree font-medium text-color-89 dark:text-color-DF hover:text-color-2C justify-center">
                                        ...
                                        <span class="ml-4 font-Figtree font-medium md:w-full w-[120px]">{{ __('Previous Post') }}</span>
                                    </a>
                            ...
                            @else
                                <a href="javaScript:void(0);"
                                    ...
                                    <svg class="mt-1.5 w-3 h-2 lg:w-4 lg:h-2.5 mr-3" xmlns="http://www.w3.org/2000/svg" width="15"
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="#898989" />
                                    </svg> <span class="ml-2 font-Figtree font-medium md:w-full w-[120px]">{{ __('Previous Post') }}</span></a>
                            @endif
                            @if ($nextUrl)
                                <div class="flex flex-col lg:items-end items-end lg:justify-end">
                                    <a href="{{ route('blog.details', $nextUrl->slug) }}"
                                        ...
                                        <span class="-ml-5 md:w-full w-[120px]">{{ __('Next Post') }}</span>
                                        <svg class="ml-2 mt-1.5 neg-transition-scale' relative w-3 h-2 lg:w-4 lg:h-2.5" width="15" height="10"
                            ...
                            <a href="javaScript:void(0);" class="process-goto disabled relative justify-center text-color-89 dark:text-color-DF font-medium lg:text-16 text-14 font-Figtree flex font-Figtree text-right">
                                <span class="-ml-5 w-[120px] md:w-full">{{ __('Next Post') }}</span>
                                <svg class="mt-1.5 relative w-3 my-1.5 h-2 lg:w-4 lg:h-2.5 ml-2" width="15" height="10"
                                    viewBox="0 0 15 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M9.70696 0L8.29274 1.41421L10.5856 3.70711H0.999849C0.447564 3.70711 -0.000150681 4.15482 -0.000150681 4.70711C-0.000150681 5.25939 0.447564 5.70711 0.999849 5.70711H10.5856L8.29274 8L9.70696 9.41421L14.4141 4.70711L9.70696 0Z"
                                        fill="#898989" />
                                    ...
                                    <div class="relative w-full md:w-1/3 sm:mb-0 mb-6">
                                        <a href="{{ route('blog.details', $relatedPost->slug) }}">
                                            <div class="w-[245px] md:w-full">
                                                ...
                                                <div class="absolute top-2.5 bg-opacity rounded-sm px-2 pt-0 pb-0.5 left-2.5">
                                        ...
                                        <a href="{{ route('blog.details', $relatedPost->slug) }}"
                                            ...
                                            {{ __('Read Now') }}
                                            <svg class="fill-current relative ml-2"
