...
class Report extends Model
{
    ...
    public function tableRow()
    {
        return [
            ...
            'TransactionReport' => array(__('Name'), __('Package Name'), __('Code'), __('Total')),
        ];
    ...
    public function getTransactionReport($from = null, $to = null, $customerName= null,  $subscriptionCode = null)
    {
        ...
        return $transaction->select('subscription_details.user_id', 'subscription_details.package_id', 'subscription_details.billing_price as totalPrice')->get();
    }
