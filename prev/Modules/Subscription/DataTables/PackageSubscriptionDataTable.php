...
class PackageSubscriptionDataTable extends DataTable
{
    ...
    */
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            ->rawColumns(['package', 'user', 'activation_date', 'next_billing_date', 'billing_price', 'billing_cycle', 'payment_status', 'status', 'action'])
            ->make(true);
    }
    ...
    */
    public function html()
    {
        ...
        ->addColumn(['data' => 'billing_price', 'name' => 'billing_price', 'title' => __('Price')])
