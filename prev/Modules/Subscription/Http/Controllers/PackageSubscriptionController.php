...
class PackageSubscriptionController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $data['meta'] = (new ContentService)->getMeta('image_maker');
    ...
    public function invoicePdf($id)
    {
        ...
        try {
            if (!empty($subscription)) {
                ...
                return printPDF($data, $subscription?->package?->name . '-' . $subscription->code . '.pdf', 'subscription::invoice_print', view('subscription::invoice_print', $data), 'pdf');
            }
        } catch (\Exception $e) {
