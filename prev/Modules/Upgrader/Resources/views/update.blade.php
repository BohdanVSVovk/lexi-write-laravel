                ...
                <div class="col-sm-8">
                    <div class="d-flex justify-content-start alert alert-secondary mt-3">
                        <ul>
                            ...
                            <li>{{ __('Get latest version of Lexi from Yusuf Ahmed.') }} 
                            ...
                            <li>{{ __('A successful update will lose custom work.') }}</li>
                        </ul>
                    </div>
                    <div class="d-flex justify-content-start alert alert-warning">
                        <b>{{ __('Before performing an update, it is strongly recommended to create a full backup of your current installation (files and database) and please contact Yusuf Ahmed') }}
