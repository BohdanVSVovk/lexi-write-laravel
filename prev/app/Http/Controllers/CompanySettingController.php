...
class CompanySettingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->isMethod('get')) {
            ...
            $data['companyData']['logo_light']  = Preference::getAll()->where('field', 'company_logo_light')->first()->fileUrl();
            $data['companyData']['logo_dark']  = Preference::getAll()->where('field', 'company_logo_dark')->first()->fileUrl();
