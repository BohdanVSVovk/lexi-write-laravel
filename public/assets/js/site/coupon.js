                    ...
                    if (result.status == 'success') {
                        ...
                        for (const key in result.data) {
                            ...
                            <span class="cursor-pointer remove-coupon">
                                ...
                                </span></p><p class="text-[#DF2F2F]">-${result.data[key]} <span>${currencyName}</span></p></div></div>`;
                            
                           planPrice -= result.data[key];
                        }
                        
                        $('.discount-price').text(planPrice.toFixed(2));
