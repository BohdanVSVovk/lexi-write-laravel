    ...
    <div class="collapse navbar-collapse">
        <ul class="navbar-nav ltr:me-auto rtl:ms-auto d-flex flex-row flex-wrap float-left nav-menu ms-2">
            ...
            <li class="nav-menu-home nav-parent">
                <a class="d-flex gap-2 align-items-center hover_line text-decoration-none" href="{{ route('frontend.index') }}" target="_blank">
                    <span>
                    ...
                    <span class="list-curent-color">{{ __('Visit Site') }}</span>
                </a>
            </li>
            <li class="ms-3 nav-parent">
                <a class="d-flex gap-2 hover_line align-items-center text-decoration-none" href="{{ route('user.dashboard') }}" target="_blank">
                    <span>
                    ...
                    <span class="list-curent-color">{{ __('Customer Panel') }}</span>
                </a>
            </li>
