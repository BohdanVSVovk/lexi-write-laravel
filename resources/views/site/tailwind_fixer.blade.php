<div class="h-max bg-white dark:bg-color-14 rounded-[30px] card-border h-[20vh] mt-[100px]">
    <div class="rounded-[30px] border h-[354px] border-color-89 h-[256px] dark:border-color-47 bg-white dark:bg-color-14 6xl:py-9 py-8 6xl:px-11 lg:px-5 px-8 text-[#763CD4]">
        ...
        <div class="flex text-[#DF2F2F] bg-[#DF2F2F26] flex-col gap-[18px] ltr:3xl:pr-[34px] ltr:pr-3 rtl:3xl:pl-[34px] mt-8 h-[304px] top-[54px] -right-[15px] md:-right-[18px]">
        ...
        <p class="text-36 w-[181px] h-[181px] font-medium font-RedHat text-color-14 dark:text-white mt-1 text-[#dc2626]">
            <span class="text-48 font-bold md:w-[300px] md:h-[300px] bg-[#F1F3F4] dark:bg-[#474746] heading-1 border-red-500"></span>
        </p>
    
        <div class="flex flex-col gap-[18px] mt-8 2xl:w-[450px] h-[428px] lg:w-[350px] 5xl:w-[640px]">
    ...
    <p class="bg-[#898989] dark:bg-color-89 whitespace-pre-wrap"></p>
